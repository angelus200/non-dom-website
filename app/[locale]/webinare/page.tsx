export default function Webinare() {
  const webinare = [
    ...
    { date: "Ressourcen", time: "Jederzeit", title: "Unternehmervermögensschutz", desc: "Umfassende Strategien und Lösungen zum Schutz Ihres unternehmerischen Vermögens.", tag: "Ressource", icon: "🛡️", url: "https://unternehmervermoegensschutz.de" },
    { date: "Ressourcen", time: "Jederzeit", title: "Wegzugsbesteuerung vermeiden", desc: "Rechtssichere Strategien zur Vermeidung der Wegzugsbesteuerung bei internationaler Verlagerung.", tag: "Ressource", icon: "✈️", url: "https://wegzugsbesteuerungvermeiden.de" },
    { date: "Ressourcen", time: "Jederzeit", title: "Investorenschutz Nordzypern", desc: "Investitionsmöglichkeiten und rechtlicher Schutz für Investoren in Nordzypern.", tag: "Ressource", icon: "🏝️", url: "https://investorenschutz-nordzypern.de" },
    { date: "Ressourcen", time: "Jederzeit", title: "Vermögensschutz International", desc: "Internationale Strategien für optimalen Vermögensschutz und steuerliche Optimierung.", tag: "Ressource", icon: "🌍", url: "https://vermoegensschutz-international.de" },
    { date: "Ressourcen", time: "Jederzeit", title: "Corona Hilfen Ratgeber", desc: "Ihr Leitfaden zu Corona-Hilfsprogrammen, Fördermitteln und Unterstützungsmaßnahmen.", tag: "Ressource", icon: "💊", url: "https://coronahilfenratgeber.de" },
    { date: "Ressourcen", time: "Jederzeit", title: "Fördermittel Ratgeber", desc: "Umfassender Überblick über verfügbare Fördermittel und Finanzierungsmöglichkeiten für Unternehmen.", tag: "Ressource", icon: "💰", url: "https://foerdermittelratgeber.com" },
  ];
            ...
            <div key={w.title} className="bg-white border-[1.5px] border-gray-200 hover:border-[#0096C7] rounded-2xl p-7 flex gap-5 items-start transition-all duration-200 hover:shadow-[0_8px_28px_rgba(0,150,199,0.12)]">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2 flex-wrap">
                  <span className={`text-xs font-bold px-2.5 py-0.5 rounded-full ${w.tag === "Kostenlos" ? "bg-green-100 text-green-700" : w.tag === "Premium" ? "bg-[rgba(0,150,199,0.1)] text-[#0096C7]" : w.tag === "Ressource" ? "bg-blue-100 text-blue-700" : "bg-purple-100 text-purple-700"}`}>{w.tag}</span>
