    ...
    <>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto grid gap-6 md:grid-cols-2">
          {targets.map((item) => (
            <div key={item.name} className="bg-white border-[1.5px] border-gray-200 hover:border-[#0096C7] rounded-2xl p-5 sm:p-6 md:p-7 transition-all duration-200 hover:shadow-[0_8px_28px_rgba(0,150,199,0.12)]">
