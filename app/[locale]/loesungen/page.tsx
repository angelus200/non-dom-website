        ...
        <div className="max-w-7xl mx-auto grid gap-6">
          {apps.map((app) => (
            <a key={app.name} href={app.href} target="_blank" rel="noopener noreferrer"
              className="bg-white border-[1.5px] border-gray-200 hover:border-[#0096C7] rounded-2xl p-5 sm:p-6 md:p-8 flex flex-col lg:flex-row gap-6 items-start transition-all duration-200 hover:shadow-[0_8px_28px_rgba(0,150,199,0.12)] group">
