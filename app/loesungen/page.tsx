...
const apps = [
  { icon: "💼", name: "Business Angel App", url: "businessangel.app", href: "https://www.businessangel.app", tags: ["Investment", "Deal-Flow", "KI-Matching"], desc: "Verbinden Sie sich mit Business Angels, optimieren Sie Ihren Deal-Flow und finden Sie durch KI-Matching die richtigen Investoren für Ihr Unternehmen." },
  { icon: "🏢", name: "ImmoPortal", url: "immoportal.app", href: "https://portal.immoportal.app", tags: ["Immobilien", "Refinanzierung", "KI-Analyse"], desc: "KI-gestützte Immobilienanalyse, automatisierte Bewertungen und smarte Refinanzierungsstrategien für Ihr Immobilienportfolio." },
  { icon: "🤖", name: "Buchhaltung KI", url: "buchhaltung-ki.app", href: "https://www.buchhaltung-ki.app", tags: ["Buchhaltung", "DATEV", "Automatisierung"], desc: "Vollautomatische Buchhaltung mit DATEV-Integration. Rechnungen, Belege und Jahresabschluss — von der KI erledigt." },
  { icon: "📦", name: "E-Commerce Rente", url: "ecommercerente.com", href: "https://www.ecommercerente.com", tags: ["Amazon FBA", "Passives Einkommen", "B2B"], desc: "Aufbau eines automatisierten Amazon FBA-Business als passives Einkommensmodell — mit KI-optimierter Produktauswahl." },
  { icon: "🔧", name: "Unternehmensoptimierung", url: "unternehmensoptimierung.app", href: "https://www.unternehmensoptimierung.app", tags: ["Holding", "Vermögensschutz", "Optimierung"], desc: "Strukturierung Ihrer Unternehmensgruppe als Holding, Vermögensschutz und steuerliche Optimierung durch KI-Analyse." },
];
